                ...
                <tbody>
                  ...
                  <tr>
                    <form method = "post">
                      ...
                      <td><button type="submit" class="btn" name = "vote1" onclick="return confirm ('Pilih nomor 1?');">Pilih</button></td>
                      <td><button  type="submit" class="btn" name = "vote2" onclick="return confirm ('Pilih nomor 2?');">Pilih</button></td>
